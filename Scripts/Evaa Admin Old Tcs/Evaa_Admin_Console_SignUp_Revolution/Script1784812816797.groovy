...
String random9Digit = String.valueOf(((Math.random() * 900000000) as long) + 100000000)
...
WebUI.verifyElementText(findTestObject('Object Repository/Evaa Admin Start Page/h1_Meet EVAA AI'), 'Meet EVAA AI')

WebUI.click(findTestObject('Object Repository/Evaa Admin Start Page/button_Sign Up'))

WebUI.verifyElementText(findTestObject('Object Repository/Welcome page/Welcome to EVAA AI Text'), 'Welcome to EVAA AI')

// ===================== PRODUCT SELECTION =====================
CustomKeywords.'common.ProductSelection.selectProductByName'('Revolution')

// ===================== ACCOUNT SIGN UP =====================
WebUI.setText(findTestObject('Object Repository/Account Sign Up Page/input_Sign Up to Your Account_Email'), GlobalVariable.randomEmail)

WebUI.click(findTestObject('Object Repository/Account Sign Up Page/button_Next'))

// ===================== ORGANIZATION DETAILS =====================
WebUI.callTestCase(findTestCase('Test Cases/Common/Admin Console/Enter Organisation Details'), [('orgName') : 'FIC', ('taxId') : random9Digit
        , ('phone') : '(123) 456-7899', ('email') : GlobalVariable.randomEmail, ('address') : '2433 Wimbledon Drive', ('city') : 'Zionsville'
        , ('state') : 'Alaska State', ('zip') : '46077', ('specialty') : 'Sp Type Ophthalmology', ('website') : urlevva])

// ===================== CREATE ACCOUNT =====================
WebUI.verifyElementText(findTestObject('Object Repository/Create Your EVAA Account Page/Create Your EVAA Account Header Text'), 
...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Create Your EVAA Account Page/input_Email Address'), 
    'value', GlobalVariable.randomEmail, 10)

WebUI.setEncryptedText(findTestObject('Object Repository/Create Your EVAA Account Page/input_Create New Password'), 'cvW8qx4B2o1WegCEDy41Xg==')

WebUI.setEncryptedText(findTestObject('Object Repository/Create Your EVAA Account Page/input_Confirm Password'), 'cvW8qx4B2o1WegCEDy41Xg==')
...
WebUI.click(findTestObject('Object Repository/Page_Unified Admin/button_Add To Cart', [('productName') : 'EVAA Intelli-scan']))

WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Unified Admin/span_Item added to cart successfully_1'), 
    3, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_Item added to cart successfully_1'), 'Item added to cart successfully')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_1'), '1')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_Agreement signed successfully. You wil_1bf869_1'), 
...
WebUI.setText(findTestObject('Object Repository/Page_Unified Admin/input_Card number_payment-numberInput'), '4242 4242 4242 4242')

WebUI.setText(findTestObject('Object Repository/Page_Unified Admin/input_MM  YY_payment-expiryInput'), '12 / 32')

WebUI.setText(findTestObject('Object Repository/Page_Unified Admin/input_Security code_payment-cvcInput'), '333')

WebUI.click(findTestObject('Object Repository/Page_Unified Admin/button_Pay Now'))

// ===================== LOGIN AFTER PAYMENT =====================
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_Unified Admin/email_id'), 10)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/email_id'), GlobalVariable.randomEmail)
...
WebUI.setText(findTestObject('Object Repository/Page_MaximEyes Identity/input_Sign In to Your Account_Username'), GlobalVariable.randomEmail)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_MaximEyes Identity/input_Sign In to Your Account_Password'), 
...
// ===================== VERIFY ACCOUNT =====================
String actualProductPurchased = WebUI.getText(findTestObject('Object Repository/demo/Page_Unified Admin/div_Intelliscan1 Providers')).replaceAll(
    '\\s+', '').trim()
...
WebUI.verifyElementText(findTestObject('Object Repository/demo/Page_Unified Admin/span_Account qaevaaai  Organization FIC'), 
...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/demo/Page_Unified Admin/input__organizationName'), 'value', 
    'FIC', 10)

WebUI.verifyElementText(findTestObject('Object Repository/demo/Page_Unified Admin/span_United States'), 'United States')

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/demo/Page_Unified Admin/input__addressLine1'), 'value', 
    '2433 Wimbledon Drive', 10)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/demo/Page_Unified Admin/input__city'), 'value', 'Zionsville', 
    10)

WebUI.verifyElementText(findTestObject('Object Repository/demo/Page_Unified Admin/span_Alaska'), 'Alaska')

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/demo/Page_Unified Admin/input__zipCode'), 'value', '46077', 
    10)
...
WebUI.setText(findTestObject('Object Repository/Practice Login/Page_Unified Admin/input_Address Line 2_addressLineTwo'), 
    'Unit 99')
...
WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Page_Unified Admin/input_Tax ID_taxId'), 'value', '123456789', 
    10)

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/Page_Unified Admin/input_Group NPI_groupNpiId'), 'value', 
    '999999999', 10)
...
// ----------------------------------------------------
WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_Sr. Test Edit Provider Edit'), 'Sr. Test Edit Provider Edit')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_Ophthalmology Edit'), 'Ophthalmology Edit')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Unified Admin/span_4444444444'), '4444444444')
