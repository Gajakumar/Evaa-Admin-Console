...
String firstName = randomLetters(8)
String lastName  = randomLetters(8)
...
WebUI.verifyElementAttributeValue(findTestObject('Book Appt With Ins/EVAA.AI React/input_First Name'), 'defaultValue', 'QA', MEDIUM_TIMEOUT)
WebUI.verifyElementAttributeValue(findTestObject('Book Appt With Ins/EVAA.AI React/input_Last Name'), 'defaultValue', 'Katalon', MEDIUM_TIMEOUT)
