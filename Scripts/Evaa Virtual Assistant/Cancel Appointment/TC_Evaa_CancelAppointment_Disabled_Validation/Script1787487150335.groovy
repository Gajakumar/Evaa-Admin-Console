...
//
//TestObject checkbox = findTestObject('Appointment Booking/Cancel Appt/input_Appointment Canceling')
//
...
//TestObject reschedulingNotAllowed = findTestObject('Appointment Booking/Cancel Appt/textarea_Appointment cancellation is not av_aaadc4')
...
TestObject cancelApptCheckbox = findTestObject('Appointment Booking/Cancel Appt/input_Appointment Canceling')
TestObject cancelApptNotAllowedMessage = findTestObject('Appointment Booking/Cancel Appt/textarea_Appointment cancellation is not av_aaadc4')
TestObject chatBotReschedulingNotAllowedMessage = findTestObject('Appointment Booking/Cancel Appt/Appointment cancellation is not available online. Please contact the office at number')
// ============================================================================
// PART 1: DISABLE RESCHEDULING & CAPTURE EXPECTED MESSAGE (ADMIN SIDE)
// ============================================================================
admin.navigateToPreferences(DEFAULT_TIMEOUT, PAGE_TIMEOUT)

boolean originalCheckboxState = admin.isReschedulingCheckboxChecked(cancelApptCheckbox)
admin.setReschedulingCheckbox(cancelApptCheckbox, false)

String adminMessage = admin.captureMessageText(cancelApptNotAllowedMessage)
admin.goToDashboard()

// ============================================================================
// PART 2: CHAT BOT APPOINTMENT BOOKING (PATIENT-FACING SITE)
// ============================================================================
chatBot.openApplication(APP_URL)
chatBot.launchChatBot(PAGE_TIMEOUT)

chatBot.sendChatMessage('Cancel Appointment')
String chatBotMessage = chatBot.getMessageText(chatBotReschedulingNotAllowedMessage)

WebUI.verifyEqual(adminMessage, chatBotMessage)
KeywordUtil.logInfo('Verified admin-configured message matches chat bot message.')

chatBot.confirmBookingIntent()
chatBot.waitForPatientDetailsForm(PAGE_TIMEOUT)
