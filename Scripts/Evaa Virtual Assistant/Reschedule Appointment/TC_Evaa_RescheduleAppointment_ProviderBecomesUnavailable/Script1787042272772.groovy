...
// Patient details
String firstName   = 'MargeA'
String lastName    = 'SimpsonA'
String patientAge  = '50yo'
String dob         = '07/10/1976'
...
String expectedRescheduleMsg    = 'Your Appointment cannot be canceled/rescheduled online. Please call the office directly'
...
WebUI.click(findTestObject('Max OA/Page_MaximEyes/a_Modules'))

WebUI.click(findTestObject('Max OA/Page_MaximEyes/a_ui-id-20'))

WebUI.click(findTestObject('Max OA/Page_MaximEyes/a_Schedule Resources'))

WebUI.setText(findTestObject('Max OA/Page_MaximEyes/input_Search in data grid'), 'Katalon Resource')

WebUI.click(findTestObject('Max OA/Page_MaximEyes/td_Katalon Resource'))

TestObject onlineScheduling = findTestObject('Max OA/Page_MaximEyes/span_Available for Online Scheduling')

if (WebUI.verifyElementChecked(onlineScheduling, 5, FailureHandling.OPTIONAL)) {
    WebUI.click(onlineScheduling)
}

WebUI.click(findTestObject('Max OA/Page_MaximEyes/input_btSubmit'))


WebUI.click(findTestObject('Max OA/Page_MaximEyes/span_mif-home font19 head-icon-shadow fg-white'))
...
//Verify user can not reschedule the appointment as it is cancelled from maximeyes side
WebUI.assertElementText(findTestObject('Object Repository/Appointment Booking/Chat Bot Appt Book/p_Your Appointment cannot be canceledrescheduled'), expectedRescheduleMsg, SHORT_TIMEOUT)
