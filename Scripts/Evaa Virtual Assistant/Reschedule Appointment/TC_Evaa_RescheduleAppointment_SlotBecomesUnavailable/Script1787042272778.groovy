...
String rescheduleApptTime         = '10:00 AM'
...
String expectedRescheduleMsg    = 'The appointment date/time you selected is no longer available. Please choose a different date/time for your appointment.'
...
String firstNameA   = 'Steffan'
String lastNameA    = 'Harvey'
String dobA         = '06/24/1985'
String apptTimeA   = '10:00 AM'
String expectedNameA            = "Name: ${firstNameA} ${lastNameA}"
String expectedTimeA            = "Time: ${apptTimeA}"
String expectedDateTimeReasonA   = "${tomorrowFullDate} | ${apptTimeA} | ${reason}"
...
String targetUrl = 'https://qa5.eyeclinic.ai/'
...
WebUI.setText(firstNameField, firstNameA)
WebUI.setText(findTestObject('Appointment Booking/Chat Bot Appt Book/input_Last Name'), lastNameA)
WebUI.setText(findTestObject('Appointment Booking/Chat Bot Appt Book/input_mm_dd_yyyy'), dobA)
WebUI.sendKeys(findTestObject('Appointment Booking/Chat Bot Appt Book/input_mm_dd_yyyy'), Keys.chord(Keys.ESCAPE))
WebUI.setText(findTestObject('Appointment Booking/Chat Bot Appt Book/input_XXX-XXX-XXXX'), phoneNumber)
WebUI.click(findTestObject('Appointment Booking/Chat Bot Appt Book/button_NEXT'))
KeywordUtil.logInfo("Step 5: Submitted - ${firstName} ${lastName}, DOB ${dob}, Phone ${phoneNumber}")
...
// STEP 9: Select appointment time
KeywordUtil.logInfo("Step 9: Selecting appointment time - ${apptTimeA}")
WebUI.click(findTestObject('Appointment Booking/Chat Bot Appt Book/button_10_30 AM', ['time': apptTimeA]))
WebUI.click(findTestObject('Appointment Booking/Chat Bot Appt Book/button_NEXT'))
...
WebUI.assertElementText(ptNameLabel, expectedNameA, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Location_ MaximEyes Family Eye Care West'), expectedLocation, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Provider_ Katalon Provider (OD)'), expectedProvider, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Reason_ Katalon Reason'), expectedReason, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Date_ 07_22_2026', ['date': tomorrowFullDate]), expectedDate, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Time_ 10_30 AM', ['time': apptTimeA]), expectedTimeA, SHORT_TIMEOUT)
WebUI.assertElementText(findTestObject('Appointment Booking/Chat Bot Appt Book/p_Your appointment has been booked'), expectedConfirmationMsg, SHORT_TIMEOUT)
...
//Verify user can not reschedule the appointment as it is booked by anaother patient
WebUI.assertElementText(findTestObject('Object Repository/Appointment Booking/Chat Bot Appt Book/p_Your Appointment cannot be canceledrescheduled online. Please call the office directly'), expectedRescheduleMsg, SHORT_TIMEOUT)

WebUI.comment('TEST COMPLETE: All appointment detail verifications for patient passed')
...
// Build the URL as a real String first — avoids GString/overload ambiguity
String targetUrlA = GlobalVariable.MaxUrlQA5
KeywordUtil.logInfo('Opening URL: ' + targetUrlA)

WebUI.executeJavaScript("window.open(arguments[0], '_blank');", [targetUrlA])
...
WebUI.click(findTestObject('MaximeyesAppt/Page_MaximEyes/MaximEyes Home Button'))


// STEP 2: Search for the patient booked in Part 1
KeywordUtil.logInfo("Step 2: Searching for patient '${firstNameA} ${lastNameA}'")
WebUI.click(findTestObject('MaximeyesAppt/Page_MaximEyes/a_imgFindPatient'))
WebUI.setText(findTestObject('MaximeyesAppt/Page_MaximEyes/input_First Name_Preferred'), firstNameA)
WebUI.setText(findTestObject('MaximeyesAppt/Page_MaximEyes/input_Last Name'), lastNameA)
WebUI.click(findTestObject('MaximeyesAppt/Page_MaximEyes/input_btnSearchPatient'))

// STEP 3: Verify appointment slot details on the search/results view
KeywordUtil.logInfo("Step 3: Verifying appointment slot shows '${expectedDateTimeReasonA}'")
