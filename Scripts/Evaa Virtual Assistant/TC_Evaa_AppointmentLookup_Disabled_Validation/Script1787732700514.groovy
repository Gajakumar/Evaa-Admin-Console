...
TestObject checkbox = findTestObject('Chat Preferences/input_Appointment Lookup')
...
WebUI.sendKeys(findTestObject('Appointment Booking/Chat Bot Appt Book/Chat Bot Enter Text Area'), 'My Upcoming Appointments')
WebUI.sendKeys(findTestObject('Appointment Booking/Chat Bot Appt Book/Chat Bot Enter Text Area'), Keys.chord(Keys.ENTER))

String expText = "Sorry, I'm not able to help with this right now. Would you like me to send a message to the staff for review and follow-up? [Send a Message to Staff]"
TestObject chatText = findTestObject('Appointment Booking/Upcoming Appt/p_Sorry, Im not able to')
WebUI.assertElementText(chatText, expText, PAGE_TIMEOUT)
